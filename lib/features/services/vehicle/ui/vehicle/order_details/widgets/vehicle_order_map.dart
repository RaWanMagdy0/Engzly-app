...
class VehicleOrderMap extends StatefulWidget {
  final String? location;

  const VehicleOrderMap({super.key, this.location});

  @override
  State<VehicleOrderMap> createState() => _VehicleOrderMap();
}

class _VehicleOrderMap extends State<VehicleOrderMap> {
  LatLng? endPoint;
