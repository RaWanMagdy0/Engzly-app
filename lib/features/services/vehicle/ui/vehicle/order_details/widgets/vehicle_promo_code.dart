...
class VehiclePromoCode extends StatefulWidget {
  final String? appliedPromoCode;
  final VoidCallback? onRemove;
  final Function(String)? onApply;

  const VehiclePromoCode({
    super.key,
  ...
  @override
  State<VehiclePromoCode> createState() => _VehiclePromoCode();
}

class _VehiclePromoCode extends State<VehiclePromoCode> {
