...
import 'painting_house_option_card.dart';

class PaintingingHouseOptionSection extends StatelessWidget {
  final List<HouseSizeModel> options;

  const PaintingingHouseOptionSection({
    super.key,
