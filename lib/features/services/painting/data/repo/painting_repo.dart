...
Future<Result<List<GetColorsResponseModel>>> getColors() {
    return executeApiCall<List<GetColorsResponseModel>>(() async {
      final token = await _getToken();
      final response = await _apiManager.getColors(token);
      return response;
    });
  }
