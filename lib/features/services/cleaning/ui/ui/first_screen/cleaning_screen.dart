...
import 'package:engzly/features/services/cleaning/ui/ui/first_screen/widgets/cleaning_counter_row.dart';
import 'package:engzly/features/services/cleaning/ui/ui/first_screen/widgets/house_size_widget/cleaning_header_section.dart';
import 'package:engzly/features/services/cleaning/ui/ui/first_screen/widgets/house_size_widget/cleaning_house_option_section.dart';
import 'package:engzly/features/services/cleaning/ui/ui/first_screen/widgets/house_size_widget/house_size_shimmer.dart';
import 'package:engzly/features/services/cleaning/ui/ui/schedule_screen/cleaning_schedule_screen.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      if (cubit.selectedHouseSize == null) {
        _showSnackBar("Please select a house size first");
        return;
      }

                      if (cubit.requiredPersons <= 0) {
        _showSnackBar("Please select at least one worker");
        return;
      }

      if (cubit.workingHours < 1) {
        _showSnackBar("Please select valid working hours");
        return;
      }
