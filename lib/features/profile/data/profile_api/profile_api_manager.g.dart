...
class _ProfileApiManager implements ProfileApiManager {
  ...
  Future<GetUserDataResponseModel> getUserData(String token) async {
    ...
    final _options = _setStreamType<GetUserDataResponseModel>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<AddLocationResponseModel> selectLocation(
    String token,
    AddLocationRequestBody selectLocationRequestBody,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{r'Authorization': token};
    _headers.removeWhere((k, v) => v == null);
    final _data = <String, dynamic>{};
    _data.addAll(selectLocationRequestBody.toJson());
    final _options = _setStreamType<AddLocationResponseModel>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddLocationResponseModel _value;
    try {
      _value = AddLocationResponseModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
